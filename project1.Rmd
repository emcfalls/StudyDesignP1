...
```{r data}
county <- read_excel("/Users/hollycui/Desktop/STA\ 522/Project1/county.xlsx", 
                     col_names = TRUE)
```
...
sample_match <- read_excel("/Users/hollycui/Desktop/STA\ 522/Project1/sample_match.xlsx",
                           col_names = TRUE)
...
# Estimates 7/1/2020
hispanic_data_2020 <- 
  read.csv('/Users/hollycui/Desktop/STA\ 522/Project1/demo_2010_2020.csv') %>% 
...
```{r}
# write.csv(sample_complete, 
#           file = "/Users/hollycui/Desktop/STA\ 522/Project1/sample_complete.csv",
#           row.names = FALSE)
```
...
(Add descriptions here! - mention svyratio() use for more accurate percentage estimate)

```{r}
sample_complete <- 
  read.csv(file = "/Users/hollycui/Desktop/STA\ 522/Project1/sample_complete.csv")
# DC certainty PSU
